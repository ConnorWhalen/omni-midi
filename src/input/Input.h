...
constexpr int GH_STAR_BUTTON_INDEX = GH_ORANGE_FRET_INDEX + 1;
constexpr int GH_TAP_BUTTON_INDEX = GH_STAR_BUTTON_INDEX + 1;
constexpr int GH_HOPO_BUTTON_INDEX = GH_TAP_BUTTON_INDEX + 1;
constexpr int GH_HOLD_BUTTON_INDEX = GH_HOPO_BUTTON_INDEX + 1;
